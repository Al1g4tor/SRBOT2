...
| !welcome | (X) | toggle the welcome message on user join. |
...
| !ajuda | — | links to an image to help get people started on plug. |
...
| !tema | — | links to the room's theme (if set in the settings). |
